...
const Terms = () => {
  return (
    ...
    <div id="about" className="min-h-screen flex flex-col items-center px-2 md:px-8 lg:px-16 overflow-hidden relative ">
      <Navbar />
      <h1 className="text-white md:text-6xl text-3xl center font-bold mt-8 mx-20 text-center ">Terms and Conditions</h1>
